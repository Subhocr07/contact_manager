...
function Contacts() {
  ...
  useEffect(() => {
    ...
    axios({
      method: "GET",
      url: "https://contact-sibu.onrender.com/user/",
      headers: {
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feBlend
                        ...
                        result="effect1_dropShadow_26_3092"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_26_3092"
                        result="shape"
                      />
                    </filter>
                  </defs>
            ...
            <div className="contact-nav-right">
              <span>
                <button className="btn" onClick={() => setpopup(3)}>
                  ...
                  >
                    <path
                      d="M11.7857 5.78055V14.8862H3.21429V5.78055H11.7857ZM10.1786 0.317139H4.82143L3.75 1.22771H0V3.04885H15V1.22771H11.25L10.1786 0.317139ZM13.9286 3.95941H1.07143V14.8862C1.07143 15.8879 2.03571 16.7074 3.21429 16.7074H11.7857C12.9643 16.7074 13.9286 15.8879 13.9286 14.8862V3.95941Z"
                      fill="black"
                    />
                  </svg>{" "}
                  Delete
              ...
              <span>
                <button className="btn" onClick={() => setpopup(1)}>
                  ...
                  >
                    <path
                      d="M4 0.317139L0 4.30476H3V11.3106H5V4.30476H8L4 0.317139ZM11 14.3188V7.31297H9V14.3188H6L10 18.3064L14 14.3188H11Z"
                      fill="black"
                    />
                  </svg>{" "}
                  Import
              ...
              <span>
                ...
                >
                  <path
                    d="M14 11.5854V14.6586H2V11.5854H0V14.6586C0 15.7854 0.9 16.7074 2 16.7074H14C15.1 16.7074 16 15.7854 16 14.6586V11.5854H14ZM3 5.43909L4.41 6.88348L7 4.24055V12.6098H9V4.24055L11.59 6.88348L13 5.43909L8 0.317139L3 5.43909Z"
                    fill="black"
                  />
                </svg>{" "}
                Export
            ...
            <thead>
              <th>
                <input
                  ...
                  value="allselect"
                  id="name"
                  onChange={(e) => deleteAll(e, "my_body")}
                />
              </th>
              ...
              <th>
                ...
                >
                  ...
                  <path
                    d="M5.25 9.82285e-05L10.5 5.2251L0 5.2251L5.25 9.82285e-05Z"
                    fill="#605750"
                  />
                </svg>
              </th>
                ...
                .map((element, i) => {
                  return (
                    <tr key={i} className="row3">
                      ...
                      <td data-for="tool" data-tip={element.email}>
                        {element.email}
                      </td>
